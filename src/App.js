    ...
    axios
      .get(
        "https://api.themoviedb.org/3/movie/" +
          props.movie.id +
          "?api_key=d41a8c9251b4b04efb0b1c86474a150e&append_to_response=videos"
      )
      .then((response) => {
...
function MovieList(props) {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api.themoviedb.org/3/movie/now_playing?api_key=d41a8c9251b4b04efb0b1c86474a150e&append_to_response=videos"
      )
      .then((response) => {
